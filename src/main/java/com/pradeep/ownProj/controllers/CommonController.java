package com.pradeep.ownProj.controllers;
...
import com.pradeep.ownProj.container.CommonBean;
import com.pradeep.ownProj.container.CommonDAO;
...
public class CommonController {
	...
	public String login(@ModelAttribute("userForm") CommonBean bean,HttpServletRequest request, HttpServletResponse response,HttpSession session,Model model) {
		...
		try {
			 ...
			 if(bean.getUsername().equals("6dadmin")&&bean.getPassword().equals("6dadmin")) { 
				bean.setStatus(0);
